...
# Deprecated compatibility alias to avoid duplicate result types.
from .peeling import IterativePeelingResult
...
def iterative_peeling_understory(
    ...
    """
    warnings.warn(
        "src.core.filtering.iterative_peeling_understory is deprecated; "
        "use src.core.peeling.iterative_peeling_understory instead.",
        DeprecationWarning,
        stacklevel=2,
    )

    from .peeling import iterative_peeling_understory as _iterative_peeling_understory_impl
